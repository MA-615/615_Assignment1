...
#correlation between the variables mpg, cyl, disp, hp, and #gear.
```
...
#without having to worry about the code. Once we have the #desired plot we can copy the ggplot code into rstudio. #Esquisser can be used in a own browser window, which makes #looking back and forth between r and the esquisser window #very easy.
```
